...
OPENBEAN_VERSION="${OPENBEAN_VERSION:-0.1.0}"
BUNDLE_URL="${OPENBEAN_BUNDLE_URL:-https://github.com/openbean/openbean/releases/download/v${OPENBEAN_VERSION}/openbean-server-bundle-v${OPENBEAN_VERSION}.tar.gz}"
